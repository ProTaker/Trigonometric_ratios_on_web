...
def simplify(func, expr):
    rules = {
        "sin": {
            "90°+θ": r"\cos\theta", "180°+θ": r"-\sin\theta", "270°+θ": r"-\cos\theta", "360°+θ": r"\sin\theta",
            "-90°+θ": r"-\cos\theta", "-180°+θ": r"-\sin\theta", "-270°+θ": r"\cos\theta", "-360°+θ": r"\sin\theta",
            "-θ": r"-\sin\theta",
            "90°-θ": r"\cos\theta", "180°-θ": r"\sin\theta", "270°-θ": r"-\cos\theta", "360°-θ": r"-\sin\theta",
            "-90°-θ": r"\cos\theta", "-180°-θ": r"-\sin\theta", "-270°-θ": r"-\cos\theta", "-360°-θ": r"-\sin\theta",
        ...
        "cos": {
            "90°+θ": r"-\sin\theta", "180°+θ": r"-\cos\theta", "270°+θ": r"\sin\theta", "360°+θ": r"\cos\theta",
            "-90°+θ": r"\sin\theta", "-180°+θ": r"-\cos\theta", "-270°+θ": r"-\sin\theta", "-360°+θ": r"\cos\theta",
            "-θ": r"\cos\theta",
            "90°-θ": r"\sin\theta", "180°-θ": r"-\cos\theta", "270°-θ": r"-\sin\theta", "360°-θ": r"\cos\theta",
            "-90°-θ": r"-\sin\theta", "-180°-θ": r"-\cos\theta", "-270°-θ": r"\sin\theta", "-360°-θ": r"\cos\theta",
        ...
        "tan": {
            "90°+θ": r"\displaystyle-\frac{1}{\tan\theta}", "180°+θ": r"\tan\theta", "270°+θ": r"\displaystyle-\frac{1}{\tan\theta}", "360°+θ": r"\tan\theta",
            "-90°+θ": r"\displaystyle-\frac{1}{\tan\theta}", "-180°+θ": r"\tan\theta", "-270°+θ": r"\displaystyle-\frac{1}{\tan\theta}", "-360°+θ": r"\tan\theta",
            "-θ": r"-\tan\theta",
            "90°-θ": r"\displaystyle\frac{1}{\tan\theta}", "180°-θ": r"-\tan\theta", "270°-θ": r"\displaystyle\frac{1}{\tan\theta}", "360°-θ": r"-\tan\theta",
            "-90°-θ": r"\displaystyle\frac{1}{\tan\theta}", "-180°-θ": r"-\tan\theta", "-270°-θ": r"\displaystyle\frac{1}{\tan\theta}", "-360°-θ": r"-\tan\theta",
